(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Comparer", "./ListClass", "./ListClass", "./Option", "./Seq", "./Seq", "./Seq", "./Seq", "./Seq", "./Symbol", "./Util", "./Util", "./Util"], factory);
    }
    ...
    function tree_tryFind(comparer, k, m) {
        tryFind: while (true) {
            if (m.tag === 1) {
                ...
                if (c === 0) {
                    return Option_1.makeSome(m.data[1]);
                }
                else {
                    return null;
                }
    ...
    function findKey(f, map) {
        return Seq_3.pick((kv) => f(kv[0], kv[1]) ? Option_1.makeSome(kv[0]) : null, map);
    }
    exports.findKey = findKey;
    function tryFindKey(f, map) {
        return Seq_4.tryPick((kv) => f(kv[0], kv[1]) ? Option_1.makeSome(kv[0]) : null, map);
    }
