(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Comparer", "./List", "./List", "./Seq", "./Seq", "./Seq", "./Seq", "./Seq", "./Seq", "./Seq", "./Symbol", "./Util"], factory);
    }
    ...
    const Seq_5 = require("./Seq");
    const Seq_6 = require("./Seq");
    const Seq_7 = require("./Seq");
