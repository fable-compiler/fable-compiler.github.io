define(["require", "exports", "../Symbol", "../Symbol", "../Util", "../Long", "../Seq", "./FFT", "../List", "../String"], function (require, exports, Symbol_1, Symbol_2, Util_1, Long_1, Seq_1, FFT_1, List_1, String_1) {
    "use strict";
    var BigNat = (function () {
    ...
    function addP(i, n, c, p, q, r) {
        if (i < n) {
            var x = (i < p.bound ? p.digits[i] : 0) + (i < q.bound ? q.digits[i] : 0) + c;
    ...
    function extractBits(n, enc, bi) {
        ...
        if (biw !== bjw) {
            var x = biw < n.bound ? n.digits[biw] : 0;
            var y = bjw < n.bound ? n.digits[bjw] : 0;
